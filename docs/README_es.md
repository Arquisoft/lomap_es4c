...
la url en la que se despliega es: [https://arquisoft.github.io/lomap_es4c/](https://arquisoft.github.io/lomap_es4c/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/lomap_es4c/](https://arquisoft.github.io/lomap_es4c/) necesitamos ejecutar `npm run deploy`.
